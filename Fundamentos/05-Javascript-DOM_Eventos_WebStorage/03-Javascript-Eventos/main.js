...
addEventListener('click', addClasse)
function addClasse() {
    liChange.className = 'tech'
}
...
input.addEventListener("input", function(event) {
    const techChange = document.querySelector('.tech');

    techChange.innerText = event.target.value
})
...
myWebpage.addEventListener('dblclick', function (){
    window.open('https://linkedin.com/in/gugasantos')
})
